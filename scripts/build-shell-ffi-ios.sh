#!/usr/bin/env bash
# Build the reflective-shell-ffi Rust crate for iOS device + simulator,
# generate Swift bindings, and assemble an XCFramework consumed by
# templates/native-shells/ios/.
#
...
LIB_BASENAME=reflective_shell_ffi
LIB_FILE="lib${LIB_BASENAME}.a"
FRAMEWORK=ReflectiveShellFFI
...
OUT_DIR="templates/native-shells/ios/CoreBridge"
mkdir -p "$OUT_DIR"
